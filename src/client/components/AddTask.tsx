...
export const PostTask: React.FC<Props> = ({ saveTask }) => {
  ...
  return (
    <form onSubmit={addNewTask} className="Add-task">
      ...
      <button className="p-0 w-10 h-10 bg-red-600 rounded-full hover:bg-red-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none">
        <svg
          viewBox="0 0 20 20"
